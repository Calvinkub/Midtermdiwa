...
└── prep/                     # 📌 สื่อเตรียมสอบ (เริ่มที่นี่)
    ...
    ├── EXAM-100-SOLUTIONS.md     # 🧮 เฉลยเต็ม — ข้อคำนวณแสดงวิธีทำครบทุกขั้น (แบบตอบตอนที่ 2)
    ├── CALC-DRILLS.html          # ✏️ โจทย์คำนวณ 20 ข้อ + เฉลยทีละ step (กดเปิด/ปิดเฉลยได้)
    ├── CHEAT-SHEET.html          # ชีตสรุป A4 × 2 หน้า (อังกฤษ) + เฉลย 100 ข้อ (แยกสีตามสัปดาห์)
    ├── CHEAT-SHEET-TH.html       # 🇹🇭 ชีตสรุปแปลไทย (เก็บคำศัพท์เทคนิค) + เฉลย 100 ข้อ พร้อมโจทย์
